                ...
                <form method="POST" action="{{ route('pesanan.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @foreach($ar_pesanan as $datax)
                            <option value="{{ $datax->idproduk }}">{{ $datax->namaproduk }}</option>
                        @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="emailpemesan" name="emailpemesan" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <input type="hidden" name="waktupesan" value="{{ date('Y-m-d H:i:s') }}">
