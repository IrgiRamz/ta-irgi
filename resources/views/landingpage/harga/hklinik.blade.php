...
<section>
    <div class="text-center mb-5">
        <h3 class="heading-3 mb-3" data-aos="fade-down" data-aos-duration="800">Harga Software Klinik Kesehatan
        </h3>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-4 mb-3">
            <div class="single-pricing">
                <h5 class="heading-5 text-dark mb-4">Pratama</h5>
                <div class="d-flex align-items-center mb-4">
                    <h4 class="heading-4 text-primary">Rp 375.000</h4>
                    <span class="text-muted">/bulan</span>
                </div>

                <div class="info-pricing mb-4">
                    Ambil 1 tahun hanya bayar 10 bulan (Diskon Rp.750.000,-)
                </div>
                ...
                <div>
                    ...
                    <div class="d-flex mb-3">
                        <i class="ri-check-line text-success me-2 mt-1"></i>
                        <span class="text-dark">Depo/Apotek</span>
                    </div>
                    <div class="d-flex mb-3">
                        <i class="ri-check-line text-success me-2 mt-1"></i>
                        <span class="text-dark">Multi Dokter/Nurse/Bidan</span>
                    </div>
                    <div class="d-flex mb-3">
                        <i class="ri-check-line text-success me-2 mt-1"></i>
                        <span class="text-dark">Medical Records</span>
                    </div>
                    <div class="d-flex mb-3">
                        <i class="ri-check-line text-success me-2 mt-1"></i>
                        <span class="text-dark">Manajemen Stok Obat/Bahan</span>
                    </div>
                    <div class="d-flex mb-3">
                        <i class="ri-check-line text-success me-2 mt-1"></i>
                        <span class="text-dark">Modul Lab & Radiologi</span>
                    </div>
                    <div class="d-flex mb-3">
                        <i class="ri-check-line text-success me-2 mt-1"></i>
                        <span class="text-dark">Terintegrasi Platform SATUSEHAT</span> -> <span class="blink">New</span>
                    </div>
                    <div class="d-flex mb-3">
                        <i class="ri-close-line text-muted me-2 mt-1"></i>
                        <span class="text-muted text-line-through">Modul Rawat Inap</span>
                    </div>
                    <div class="d-flex mb-3">
                        <i class="ri-check-line text-success me-2 mt-1"></i>
                        <span class="text-dark">Bantuan by Phone/WA/Remote Conn</span>
                    </div>
        ...
        <div class="col-lg-4 mb-3">
            <div class="single-pricing">
                <h5 class="heading-5 text-dark mb-4">Utama</h5>
                <div class="d-flex align-items-center mb-4">
                ...
                <div class="info-pricing mb-4">
                    Ambil setahun hanya bayar 10 bulan (Diskon Rp.950.000,-)
                </div>
                ...
                <div>
                    ...
                    <div class="d-flex mb-3">
                        <i class="ri-check-line text-success me-2 mt-1"></i>
                        <span class="text-dark">Modul Rawat Inap</span>
                    </div>
                    <div class="d-flex mb-3">
                        <i class="ri-check-line text-success me-2 mt-1"></i>
                        <span class="text-dark">Bantuan by Phone/WA/Remote Conn</span>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="d-flex mb-3">
                ...
                <span>Pembayaran dimuka, minimal 12 bulan pemakaian</span> 
            </div>

            <div class="d-flex mb-3">
                <i class="ri-arrow-right-circle-line text-white me-2 mt-1"></i>
                <span>Pemakaian 12 bulan bayar (cuma) 10 bulan</span>
            </div>
            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item mb-4">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                        data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            Database yg tersimpan di server kami pada dasarnya milik Klinik, karena itu Anda bisa
                            meminta setiap saat database tersebut.
                        </div>
                    </div>
                </div>
                <div class="accordion-item mb-4">
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                        data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            Account dan akses ke sistem langsung aktif maksimal 5 menit sejak konfirmasi pembayaran
                            kami terima - khusus Hari/Jam Kerja (apabila diluar Hari/Jam Kerja sekitar 30 menit).
                        </div>
                    </div>
                </div>
                <div class="accordion-item mb-4">
