...
<section>
  <div class="text-center mb-5">
      <h3 class="heading-3 mb-3" data-aos="fade-down" data-aos-duration="800">Harga Software Klinik Gigi
      </h3>
  ...
  <div class="row justify-content-center">
      <div class="col-lg-4 mb-3">
          <div class="single-pricing">
              <h5 class="heading-5 text-dark mb-4">Standar</h5>
              ...
              <div>
                  ...
                  <div class="d-flex mb-3">
                      <i class="ri-check-line text-success me-2 mt-1"></i>
                      <span class="text-dark">Gudang & Depo/Apotek</span>
                  </div>
                  <div class="d-flex mb-3">
                      <i class="ri-check-line text-success me-2 mt-1"></i>
                      <span class="text-dark">Multi Dokter/Nurse</span>
                  </div>
                  <div class="d-flex mb-3">
                      <i class="ri-check-line text-success me-2 mt-1"></i>
                  ...
                  <div class="d-flex mb-3">
                      <i class="ri-check-line text-success me-2 mt-1"></i>
                      <span class="text-dark">Modul Odontogram Lengkap</span>
                  </div>
                  <div class="d-flex mb-3">
                      <i class="ri-check-line text-success me-2 mt-1"></i>
                  ...
                  <div class="d-flex mb-3">
                      <i class="ri-close-line text-muted me-2 mt-1"></i>
                      <span class="text-muted text-line-through">Terintegrasi Platform SATUSEHAT</span> -> <span class="blink">New</span>
                  </div>
              </div>
      ...
      <div class="col-lg-4 mb-3">
          <div class="single-pricing">
              ...
              <div class="info-pricing mb-4">
                  Ambil setahun hanya bayar 10 bulan (Diskon Rp.1.150.000,-)
              </div>
      ...
      <div class="row justify-content-center">
          ...
          <h3 class="heading-3 mb-3" data-aos="fade-down" data-aos-duration="800">CATATAN PENTING :</h3>
              ...
              <div class="d-flex mb-3">
                  ...
                  <span>Pembayaran dilakukan dimuka,<strong> minimal pemakaian 1 bulan</strong></span>
              </div>
      ...
      <div class="row">
          <div class="col-lg-10 text-center">
              ...
              <div class="position-relative">
                  <img src="{{ asset('images/landingpage/dental-mockup.webp') }}" alt="Software Klinik Gigi, Dental Care, Dental Clinic" class="img-fluid">
